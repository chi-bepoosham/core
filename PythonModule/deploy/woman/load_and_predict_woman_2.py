...
model_tarh_shalvar = load_modelll('tarh_shalvar//models//wwpantsprint.h5',class_num=5, base_model="resnet101")
model_skirt_pants = load_modelll('F://chibeposham_team_git//skirt_pants//models//skirt_pants.h5',class_num=2, base_model="resnet101")
model_yaghe = load_modelll('F://chibeposham_team_git//yaghe//models//yaghewoman101A.h5',class_num=11, base_model="resnet101")
model_body_type = load_modelll('F://chibeposham_team_git//body_type//models//woman_body_type.h5',class_num=5, base_model="resnet101")
...
predict_class(image,model=model_body_type,
              class_names=["11","21","31","41","51"],reso=300)
