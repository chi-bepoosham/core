INSERT INTO "public"."provinces" VALUES (1, 'آذربایجان شرقی', 'آذربایجان-شرقی');

INSERT INTO "public"."provinces" VALUES (2, 'آذربایجان غربی', 'آذربایجان-غربی');
...
INSERT INTO "public"."provinces" VALUES (9, 'چهارمحال و بختیاری', 'چهارمحال-بختیاری');

INSERT INTO "public"."provinces" VALUES (10, 'خراسان جنوبی', 'خراسان-جنوبی');

INSERT INTO "public"."provinces" VALUES (11, 'خراسان رضوی', 'خراسان-رضوی');

INSERT INTO "public"."provinces" VALUES (12, 'خراسان شمالی', 'خراسان-شمالی');
...
INSERT INTO "public"."provinces" VALUES (16, 'سیستان و بلوچستان', 'سیستان-بلوچستان');
...
INSERT INTO "public"."provinces" VALUES (23, 'کهگیلویه و بویراحمد', 'کهگیلویه-بویراحمد');
